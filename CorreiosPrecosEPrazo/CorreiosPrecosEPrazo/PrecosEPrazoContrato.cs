...
namespace CorreiosPrecosEPrazo
{
    public partial class PrecosEPrazoContrato : Form
    {
        ...
        {
            if (codigo == ConfiguracoesExcel.CodigoSARAParaCartaRegistradaAVista)
            {
                inicializarCartaRegistrada(precoEPrazo);
            }
            else if (codigo == ConfiguracoesExcel.CodigoSARAParaSEDEXAVista)
            {
                inicializarSedex(precoEPrazo);
            }
            else if (codigo == ConfiguracoesExcel.CodigoSARAParaPACAVista)
            {
                inicializarPAC(precoEPrazo);
            }
            else if (codigo == ConfiguracoesExcel.CodigoSARAParaSEDEX12AVista)
            {
                inicializarSedex12(precoEPrazo);
            }
            else if (codigo == ConfiguracoesExcel.CodigoSARAParaSEDEX10AVista)
            {
                inicializarSedex10(precoEPrazo);
            }
            else if (codigo == ConfiguracoesExcel.CodigoSARAParaSEDEXHojeAVista)
            {
